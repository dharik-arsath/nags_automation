...
data_dict = {
    ...
    "entries": [
        ...
        },
        {
            ...
            "date": "2025-01-11",
            "time": "19:14",
            "product_name": "200 ml panner (192)",
            "line": "ss kottai",
            "cases": 10,
            "pieces": 10,
            "discount": 437.5,
...
class ProductSheetHandler:
    ...
    def parse_product_entries(self):
            ...
            for header in headers:
                ...
                if header == "DISCOUNT":
                    ...
                    for discount in entry.discount:
                        discount_amount = (
                            discount.get("cases", 0) * discount.get("size", 0)
                ...
                if header == "COMMISSION":
                    ...
                    for commission in entry.commission:
                        commission_amount = (
                            commission.get("cases", 0) * commission.get("size", 0)
                        ) + (
                            commission.get("pieces", 0)
                            * (commission.get("size", 0) / 24)
                        )
        ...
        try:
            ...
            row_data[-1][net_amout_idx] = (
                (final_amount - self.sheet_info.total_expense)
                + credits_receivable
                - credits_payable
            )
            ...
            row_data[-1][credit_receivable_desc_idx] = (
                self.sheet_info.credits.receivable_desc
            )
