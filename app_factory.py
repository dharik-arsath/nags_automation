...
def create_app():
    ...
    from models import Products, Drivers, Lines, Expenses,Prices,Gains,Commissions, Discounts, Base
    ...
    class ProductView(ModelView):
        column_list = ["name", "max_case_count", "kuraivu", "price", "commissions", "discounts", "gains"]
